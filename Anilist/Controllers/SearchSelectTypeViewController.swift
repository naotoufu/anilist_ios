//
//  SearchSelectTypeViewController.swift
//  Anilist
//
...
class SearchSelectTypeViewController: UIViewController, SearchSelectViewControllerProtocol {
    let tableVC = SearchSelectTypeTableViewController()
    ...
    init(scpresenter: SearchConditionPresenter) {
        super.init(nibName: "\(SearchSelectTypeViewController.self)", bundle: nil)
