//
//  SearchSelectSeasonTableViewController.swift
//  Anilist
//
...
class SearchSelectSeasonTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return SearchDetailSeasonType.allCases.count
    }
    
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let type = SearchDetailSeasonType(rawValue: indexPath.row) else {fatalError()}
