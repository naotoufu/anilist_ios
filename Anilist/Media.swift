...
struct Media {
    ...
    // markdown
    var description(asHtml: Bool): String
    ...
    var studios(sort: [StudioSort], isMain: Boolean): StudioConnection
    ...
    // page: The page
    // perPage: The amount of entries per page, max 25
    var airingSchedule(notYetAired: Boolean, page: Int, perPage: Int): AiringScheduleConnection
    ...
    // page: The page
    // perPage: The amount of entries per page, max 25
    var trends(sort: [MediaTrendSort], releasing: Boolean, page: Int, perPage: Int): MediaTrendConnection
